...
const API_UPDATES_URL = `${process.env.REACT_APP_API_BASE_URL || "http://localhost:5000"}/api/updates`
    ...
    const fetchNewsData = async () => {
      try {
        ...
        const formattedStories = data.map(story => ({
          ...story,
          id: story._id,
          image: story.image.startsWith('http') ? story.image : `${process.env.REACT_APP_API_BASE_URL || "http://localhost:5000"}${story.image}`
        }))
